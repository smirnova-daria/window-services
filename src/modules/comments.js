export const comments = () => {
                ...
                commentItem.innerHTML = `					
						<div class="col-xs-9 col-sm-9">
							<div class="review-inner ${
                                reviewColors[comment.id % reviewColors.length]
    ...
    reviewsBlock.innerHTML = `<div style="padding-left:33%;"><img src="/dist/images/spinner.svg" alt="spinner"></div>`

    getData('/dist/comments.json')
        .then((data) => {
            //Добавила SetTimeout, чтобы нагляднее отобразить момент загрузки комментариев с "сервера"
            setTimeout(() => {
                try {
